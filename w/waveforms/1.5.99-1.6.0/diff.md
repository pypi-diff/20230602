# Comparing `tmp/waveforms-1.5.99.tar.gz` & `tmp/waveforms-1.6.0.tar.gz`
...
### Comparing `waveforms-1.5.99/waveforms/math/fit/simple.py` & `waveforms-1.6.0/waveforms/math/fit/simple.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.99/waveforms/math/fit/spectrum.py` & `waveforms-1.6.0/waveforms/math/fit/spectrum.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.99/waveforms/math/graph.py` & `waveforms-1.6.0/waveforms/math/graph.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.99/waveforms/math/group/_SU_n_.py` & `waveforms-1.6.0/waveforms/math/group/_SU_n_.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.99/waveforms/math/group/permutation_group.py` & `waveforms-1.6.0/waveforms/math/group/permutation_group.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.99/waveforms/math/prime.py` & `waveforms-1.6.0/waveforms/math/prime.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.99/waveforms/math/signal/demodulate.py` & `waveforms-1.6.0/waveforms/math/signal/demodulate.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.99/waveforms/math/signal/distortion.py` & `waveforms-1.6.0/waveforms/math/signal/distortion.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.99/waveforms/math/signal/func.py` & `waveforms-1.6.0/waveforms/math/signal/func.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.99/waveforms/math/transmon.py` & `waveforms-1.6.0/waveforms/math/transmon.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.99/waveforms/namespace.py` & `waveforms-1.6.0/waveforms/namespace.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.99/waveforms/qlisp/__init__.py` & `waveforms-1.6.0/waveforms/qlisp/__init__.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.99/waveforms/qlisp/arch/__init__.py` & `waveforms-1.6.0/waveforms/qlisp/arch/__init__.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.99/waveforms/qlisp/assembly.py` & `waveforms-1.6.0/waveforms/qlisp/assembly.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.99/waveforms/qlisp/base.py` & `waveforms-1.6.0/waveforms/qlisp/base.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.99/waveforms/qlisp/commands.py` & `waveforms-1.6.0/waveforms/qlisp/commands.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.99/waveforms/qlisp/compiler.py` & `waveforms-1.6.0/waveforms/qlisp/compiler.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.99/waveforms/qlisp/config.py` & `waveforms-1.6.0/waveforms/qlisp/config.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.99/waveforms/qlisp/interpreter.py` & `waveforms-1.6.0/waveforms/qlisp/interpreter.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.99/waveforms/qlisp/library.py` & `waveforms-1.6.0/waveforms/qlisp/library.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.99/waveforms/qlisp/libs/__init__.py` & `waveforms-1.6.0/waveforms/qlisp/libs/__init__.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.99/waveforms/qlisp/macro.py` & `waveforms-1.6.0/waveforms/qlisp/macro.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.99/waveforms/qlisp/parse.py` & `waveforms-1.6.0/waveforms/qlisp/parse.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.99/waveforms/qlisp/prog.py` & `waveforms-1.6.0/waveforms/qlisp/prog.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.99/waveforms/qlisp/qasm/__init__.py` & `waveforms-1.6.0/waveforms/qlisp/qasm/__init__.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.99/waveforms/qlisp/qasm/eval.py` & `waveforms-1.6.0/waveforms/qlisp/qasm/eval.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.99/waveforms/qlisp/qasm/exceptions.py` & `waveforms-1.6.0/waveforms/qlisp/qasm/exceptions.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.99/waveforms/qlisp/qasm/libs/qelib1.inc` & `waveforms-1.6.0/waveforms/qlisp/qasm/libs/qelib1.inc`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.99/waveforms/qlisp/qasm/node/__init__.py` & `waveforms-1.6.0/waveforms/qlisp/qasm/node/__init__.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.99/waveforms/qlisp/qasm/node/barrier.py` & `waveforms-1.6.0/waveforms/qlisp/qasm/node/barrier.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.99/waveforms/qlisp/qasm/node/binaryop.py` & `waveforms-1.6.0/waveforms/qlisp/qasm/node/binaryop.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.99/waveforms/qlisp/qasm/node/binaryoperator.py` & `waveforms-1.6.0/waveforms/qlisp/qasm/node/binaryoperator.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.99/waveforms/qlisp/qasm/node/creg.py` & `waveforms-1.6.0/waveforms/qlisp/qasm/node/creg.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.99/waveforms/qlisp/qasm/node/customunitary.py` & `waveforms-1.6.0/waveforms/qlisp/qasm/node/customunitary.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.99/waveforms/qlisp/qasm/node/expressionlist.py` & `waveforms-1.6.0/waveforms/qlisp/qasm/node/expressionlist.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.99/waveforms/qlisp/qasm/node/external.py` & `waveforms-1.6.0/waveforms/qlisp/qasm/node/external.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.99/waveforms/qlisp/qasm/node/format.py` & `waveforms-1.6.0/waveforms/qlisp/qasm/node/format.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.99/waveforms/qlisp/qasm/node/gate.py` & `waveforms-1.6.0/waveforms/qlisp/qasm/node/gate.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.99/waveforms/qlisp/qasm/node/gatebody.py` & `waveforms-1.6.0/waveforms/qlisp/qasm/node/gatebody.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.99/waveforms/qlisp/qasm/node/id.py` & `waveforms-1.6.0/waveforms/qlisp/qasm/node/id.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.99/waveforms/qlisp/qasm/node/idlist.py` & `waveforms-1.6.0/waveforms/qlisp/qasm/node/idlist.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.99/waveforms/qlisp/qasm/node/if_.py` & `waveforms-1.6.0/waveforms/qlisp/qasm/node/if_.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.99/waveforms/qlisp/qasm/node/indexedid.py` & `waveforms-1.6.0/waveforms/qlisp/qasm/node/indexedid.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.99/waveforms/qlisp/qasm/node/intnode.py` & `waveforms-1.6.0/waveforms/qlisp/qasm/node/intnode.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.99/waveforms/qlisp/qasm/node/measure.py` & `waveforms-1.6.0/waveforms/qlisp/qasm/node/measure.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.99/waveforms/qlisp/qasm/node/node.py` & `waveforms-1.6.0/waveforms/qlisp/qasm/node/node.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.99/waveforms/qlisp/qasm/node/nodeexception.py` & `waveforms-1.6.0/waveforms/qlisp/qasm/node/nodeexception.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.99/waveforms/qlisp/qasm/node/opaque.py` & `waveforms-1.6.0/waveforms/qlisp/qasm/node/opaque.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.99/waveforms/qlisp/qasm/node/prefix.py` & `waveforms-1.6.0/waveforms/qlisp/qasm/node/prefix.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.99/waveforms/qlisp/qasm/node/primarylist.py` & `waveforms-1.6.0/waveforms/qlisp/qasm/node/primarylist.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.99/waveforms/qlisp/qasm/node/program.py` & `waveforms-1.6.0/waveforms/qlisp/qasm/node/program.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.99/waveforms/qlisp/qasm/node/qreg.py` & `waveforms-1.6.0/waveforms/qlisp/qasm/node/qreg.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.99/waveforms/qlisp/qasm/node/real.py` & `waveforms-1.6.0/waveforms/qlisp/qasm/node/real.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.99/waveforms/qlisp/qasm/node/reset.py` & `waveforms-1.6.0/waveforms/qlisp/qasm/node/reset.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.99/waveforms/qlisp/qasm/node/unaryoperator.py` & `waveforms-1.6.0/waveforms/qlisp/qasm/node/unaryoperator.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.99/waveforms/qlisp/qasm/qasm.py` & `waveforms-1.6.0/waveforms/qlisp/qasm/qasm.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.99/waveforms/qlisp/qasm/qasmlexer.py` & `waveforms-1.6.0/waveforms/qlisp/qasm/qasmlexer.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.99/waveforms/qlisp/qasm/qasmparser.py` & `waveforms-1.6.0/waveforms/qlisp/qasm/qasmparser.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.99/waveforms/qlisp/simulator/__init__.py` & `waveforms-1.6.0/waveforms/qlisp/simulator/__init__.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.99/waveforms/qlisp/simulator/mat.py` & `waveforms-1.6.0/waveforms/qlisp/simulator/mat.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.99/waveforms/qlisp/simulator/simple.py` & `waveforms-1.6.0/waveforms/qlisp/simulator/simple.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.99/waveforms/qlisp/tokenize.py` & `waveforms-1.6.0/waveforms/qlisp/tokenize.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.99/waveforms/qlisp/utils.py` & `waveforms-1.6.0/waveforms/qlisp/utils.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.99/waveforms/quantum/clifford/clifford.py` & `waveforms-1.6.0/waveforms/quantum/clifford/clifford.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.99/waveforms/quantum/clifford/db.py` & `waveforms-1.6.0/waveforms/quantum/clifford/db.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.99/waveforms/quantum/clifford/mat.py` & `waveforms-1.6.0/waveforms/quantum/clifford/mat.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.99/waveforms/quantum/clifford/seq2mat.py` & `waveforms-1.6.0/waveforms/quantum/clifford/seq2mat.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.99/waveforms/quantum/math.py` & `waveforms-1.6.0/waveforms/quantum/math.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.99/waveforms/quantum/rb.py` & `waveforms-1.6.0/waveforms/quantum/rb.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.99/waveforms/quantum/tomo.py` & `waveforms-1.6.0/waveforms/quantum/tomo.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.99/waveforms/quantum/transmon.py` & `waveforms-1.6.0/waveforms/quantum/transmon.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.99/waveforms/quantum/xeb.py` & `waveforms-1.6.0/waveforms/quantum/xeb.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.99/waveforms/registry.py` & `waveforms-1.6.0/waveforms/registry.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.99/waveforms/scan_iter.py` & `waveforms-1.6.0/waveforms/scan_iter.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.99/waveforms/security/verify.py` & `waveforms-1.6.0/waveforms/security/verify.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.99/waveforms/server/__init__.py` & `waveforms-1.6.0/waveforms/server/__init__.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.99/waveforms/server/__main__.py` & `waveforms-1.6.0/waveforms/server/__main__.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.99/waveforms/server/umsgpack.py` & `waveforms-1.6.0/waveforms/server/umsgpack.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.99/waveforms/sys/chat.py` & `waveforms-1.6.0/waveforms/sys/chat.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.99/waveforms/sys/device/basedevice.py` & `waveforms-1.6.0/waveforms/sys/device/basedevice.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.99/waveforms/sys/device/loader.py` & `waveforms-1.6.0/waveforms/sys/device/loader.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.99/waveforms/sys/device/utils.py` & `waveforms-1.6.0/waveforms/sys/device/utils.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.99/waveforms/sys/drivers/FakeInstrument.py` & `waveforms-1.6.0/waveforms/sys/drivers/FakeInstrument.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.99/waveforms/sys/ipy_events.py` & `waveforms-1.6.0/waveforms/sys/ipy_events.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.99/waveforms/sys/net/dhcp.py` & `waveforms-1.6.0/waveforms/sys/net/dhcp.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.99/waveforms/sys/net/dhcpd.py` & `waveforms-1.6.0/waveforms/sys/net/dhcpd.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.99/waveforms/sys/net/kad.py` & `waveforms-1.6.0/waveforms/sys/net/kad.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.99/waveforms/sys/net/kcp.py` & `waveforms-1.6.0/waveforms/sys/net/kcp.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.99/waveforms/sys/progress.py` & `waveforms-1.6.0/waveforms/sys/progress.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.99/waveforms/sys/storage/crud.py` & `waveforms-1.6.0/waveforms/sys/storage/crud.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.99/waveforms/sys/storage/models.py` & `waveforms-1.6.0/waveforms/sys/storage/models.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.99/waveforms/units/__init__.py` & `waveforms-1.6.0/waveforms/units/__init__.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.99/waveforms/visualization/__init__.py` & `waveforms-1.6.0/waveforms/visualization/__init__.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.99/waveforms/visualization/__main__.py` & `waveforms-1.6.0/waveforms/visualization/__main__.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.99/waveforms/visualization/plot_layout.py` & `waveforms-1.6.0/waveforms/visualization/plot_layout.py`
...
### Comparing `waveforms-1.5.99/waveforms/visualization/plot_seq.py` & `waveforms-1.6.0/waveforms/visualization/plot_seq.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.99/waveforms/visualization/qdat.py` & `waveforms-1.6.0/waveforms/visualization/qdat.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.99/waveforms/waveform.py` & `waveforms-1.6.0/waveforms/waveform.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.99/waveforms/waveform_parser.py` & `waveforms-1.6.0/waveforms/waveform_parser.py`

 * *Files identical despite different names*

### Comparing `waveforms-1.5.99/waveforms.egg-info/PKG-INFO` & `waveforms-1.6.0/waveforms.egg-info/PKG-INFO`
...
### Comparing `waveforms-1.5.99/waveforms.egg-info/SOURCES.txt` & `waveforms-1.6.0/waveforms.egg-info/SOURCES.txt`
