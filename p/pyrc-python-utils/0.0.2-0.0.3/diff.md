# Comparing `tmp/pyrc-python-utils-0.0.2.tar.gz` & `tmp/pyrc-python-utils-0.0.3.tar.gz`
...
+gzip compressed data, was "pyrc-python-utils-0.0.3.tar", last modified: Fri Jun  2 15:18:05 2023, max compression
```

## Comparing `pyrc-python-utils-0.0.2.tar` & `pyrc-python-utils-0.0.3.tar`
...
+drwxrwxrwx   0        0        0        0 2023-06-02 15:18:05.421624 pyrc-python-utils-0.0.3/
+-rw-rw-rw-   0        0        0     1085 2023-05-30 19:52:10.000000 pyrc-python-utils-0.0.3/LICENSE
+-rw-rw-rw-   0        0        0       57 2023-05-30 19:52:10.000000 pyrc-python-utils-0.0.3/MANIFEST.in
+-rw-rw-rw-   0        0        0      408 2023-06-02 15:18:05.420623 pyrc-python-utils-0.0.3/PKG-INFO
+-rw-rw-rw-   0        0        0       63 2023-05-30 19:52:10.000000 pyrc-python-utils-0.0.3/README.md
+-rw-rw-rw-   0        0        0      654 2023-06-02 15:17:53.000000 pyrc-python-utils-0.0.3/pyproject.toml
+-rw-rw-rw-   0        0        0       42 2023-06-02 15:18:05.421624 pyrc-python-utils-0.0.3/setup.cfg
+drwxrwxrwx   0        0        0        0 2023-06-02 15:18:05.391625 pyrc-python-utils-0.0.3/src/
+-rw-rw-rw-   0        0        0        0 2023-06-01 11:37:45.000000 pyrc-python-utils-0.0.3/src/__init__.py
+drwxrwxrwx   0        0        0        0 2023-06-02 15:18:05.407624 pyrc-python-utils-0.0.3/src/pyrc_python_utils/
+-rw-rw-rw-   0        0        0        0 2023-05-30 19:52:10.000000 pyrc-python-utils-0.0.3/src/pyrc_python_utils/__init__.py
+-rw-rw-rw-   0        0        0     1199 2023-06-01 11:13:12.000000 pyrc-python-utils-0.0.3/src/pyrc_python_utils/util_datetime.py
+-rw-rw-rw-   0        0        0     5776 2023-06-01 11:13:12.000000 pyrc-python-utils-0.0.3/src/pyrc_python_utils/util_exchange.py
+-rw-rw-rw-   0        0        0     3438 2023-06-02 11:30:13.000000 pyrc-python-utils-0.0.3/src/pyrc_python_utils/util_file.py
+-rw-rw-rw-   0        0        0     1382 2023-06-01 11:13:12.000000 pyrc-python-utils-0.0.3/src/pyrc_python_utils/util_ms_teams.py
+-rw-rw-rw-   0        0        0    19028 2023-06-02 12:54:00.000000 pyrc-python-utils-0.0.3/src/pyrc_python_utils/util_s3.py
+-rw-rw-rw-   0        0        0    30466 2023-06-01 11:13:12.000000 pyrc-python-utils-0.0.3/src/pyrc_python_utils/util_sftp.py
+-rw-rw-rw-   0        0        0     6440 2023-06-01 11:13:12.000000 pyrc-python-utils-0.0.3/src/pyrc_python_utils/util_sharepoint.py
+-rw-rw-rw-   0        0        0       77 2023-06-01 11:13:12.000000 pyrc-python-utils-0.0.3/src/pyrc_python_utils/util_string.py
+drwxrwxrwx   0        0        0        0 2023-06-02 15:18:05.416624 pyrc-python-utils-0.0.3/src/pyrc_python_utils.egg-info/
+-rw-rw-rw-   0        0        0      408 2023-06-02 15:18:05.000000 pyrc-python-utils-0.0.3/src/pyrc_python_utils.egg-info/PKG-INFO
+-rw-rw-rw-   0        0        0      638 2023-06-02 15:18:05.000000 pyrc-python-utils-0.0.3/src/pyrc_python_utils.egg-info/SOURCES.txt
+-rw-rw-rw-   0        0        0        1 2023-06-02 15:18:05.000000 pyrc-python-utils-0.0.3/src/pyrc_python_utils.egg-info/dependency_links.txt
+-rw-rw-rw-   0        0        0       62 2023-06-02 15:18:05.000000 pyrc-python-utils-0.0.3/src/pyrc_python_utils.egg-info/requires.txt
+-rw-rw-rw-   0        0        0       27 2023-06-02 15:18:05.000000 pyrc-python-utils-0.0.3/src/pyrc_python_utils.egg-info/top_level.txt
+drwxrwxrwx   0        0        0        0 2023-06-02 15:18:05.418624 pyrc-python-utils-0.0.3/tests/
+-rw-rw-rw-   0        0        0    12451 2023-06-02 12:37:28.000000 pyrc-python-utils-0.0.3/tests/test_util_s3.py
```

### Comparing `pyrc-python-utils-0.0.2/LICENSE` & `pyrc-python-utils-0.0.3/LICENSE`

 * *Files identical despite different names*

### Comparing `pyrc-python-utils-0.0.2/pyproject.toml` & `pyrc-python-utils-0.0.3/pyproject.toml`
...
### Comparing `pyrc-python-utils-0.0.2/src/pyrc_python_utils/util_datetime.py` & `pyrc-python-utils-0.0.3/src/pyrc_python_utils/util_datetime.py`
...
### Comparing `pyrc-python-utils-0.0.2/src/pyrc_python_utils/util_exchange.py` & `pyrc-python-utils-0.0.3/src/pyrc_python_utils/util_exchange.py`
...
### Comparing `pyrc-python-utils-0.0.2/src/pyrc_python_utils/util_ms_teams.py` & `pyrc-python-utils-0.0.3/src/pyrc_python_utils/util_ms_teams.py`
...
### Comparing `pyrc-python-utils-0.0.2/src/pyrc_python_utils/util_sftp.py` & `pyrc-python-utils-0.0.3/src/pyrc_python_utils/util_sftp.py`
...
### Comparing `pyrc-python-utils-0.0.2/src/pyrc_python_utils/util_sharepoint.py` & `pyrc-python-utils-0.0.3/src/pyrc_python_utils/util_sharepoint.py`
...
### Comparing `pyrc-python-utils-0.0.2/src/pyrc_python_utils.egg-info/SOURCES.txt` & `pyrc-python-utils-0.0.3/src/pyrc_python_utils.egg-info/SOURCES.txt`
