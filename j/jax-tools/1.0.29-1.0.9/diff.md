# Comparing `tmp/jax-tools-1.0.29.tar.gz` & `tmp/jax-tools-1.0.9.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "jax-tools-1.0.29.tar", last modified: Fri Jun  2 07:30:49 2023, max compression
+gzip compressed data, was "jax-tools-1.0.9.tar", last modified: Thu Jun  1 04:58:33 2023, max compression
```

## Comparing `jax-tools-1.0.29.tar` & `jax-tools-1.0.9.tar`

### file list

```diff
@@ -1,24 +1,21 @@
-drwxr-xr-x   0 cyber.anonym   (501) staff       (20)        0 2023-06-02 07:30:49.143021 jax-tools-1.0.29/
--rw-r--r--   0 cyber.anonym   (501) staff       (20)      965 2023-06-02 07:30:49.142548 jax-tools-1.0.29/PKG-INFO
--rw-r--r--   0 cyber.anonym   (501) staff       (20)      582 2023-06-01 06:56:40.000000 jax-tools-1.0.29/README.md
-drwxr-xr-x   0 cyber.anonym   (501) staff       (20)        0 2023-06-02 07:30:49.136561 jax-tools-1.0.29/jax_tools/
--rw-r--r--   0 cyber.anonym   (501) staff       (20)        0 2023-05-31 12:57:36.000000 jax-tools-1.0.29/jax_tools/__init__.py
--rw-r--r--   0 cyber.anonym   (501) staff       (20)     6222 2023-06-01 10:53:38.000000 jax-tools-1.0.29/jax_tools/colorful_font.py
--rw-r--r--   0 cyber.anonym   (501) staff       (20)     4387 2023-06-02 06:44:22.000000 jax-tools-1.0.29/jax_tools/encrypt.py
--rw-r--r--   0 cyber.anonym   (501) staff       (20)     1733 2023-06-02 06:47:01.000000 jax-tools-1.0.29/jax_tools/jax_encrypt.py
--rw-r--r--   0 cyber.anonym   (501) staff       (20)     1919 2023-06-01 08:32:18.000000 jax-tools-1.0.29/jax_tools/logger.py
--rw-r--r--   0 cyber.anonym   (501) staff       (20)     3385 2023-06-02 07:27:14.000000 jax-tools-1.0.29/jax_tools/network_test.py
--rw-r--r--   0 cyber.anonym   (501) staff       (20)      651 2023-06-02 07:00:58.000000 jax-tools-1.0.29/jax_tools/proxies.py
--rw-r--r--   0 cyber.anonym   (501) staff       (20)     2846 2023-06-02 07:30:44.000000 jax-tools-1.0.29/jax_tools/ssh.py
-drwxr-xr-x   0 cyber.anonym   (501) staff       (20)        0 2023-06-02 07:30:49.142077 jax-tools-1.0.29/jax_tools/utils/
--rw-r--r--   0 cyber.anonym   (501) staff       (20)        0 2023-05-31 13:11:26.000000 jax-tools-1.0.29/jax_tools/utils/__init__.py
--rw-r--r--   0 cyber.anonym   (501) staff       (20)      254 2023-06-01 08:29:19.000000 jax-tools-1.0.29/jax_tools/utils/settings.py
-drwxr-xr-x   0 cyber.anonym   (501) staff       (20)        0 2023-06-02 07:30:49.140183 jax-tools-1.0.29/jax_tools.egg-info/
--rw-r--r--   0 cyber.anonym   (501) staff       (20)      965 2023-06-02 07:30:48.000000 jax-tools-1.0.29/jax_tools.egg-info/PKG-INFO
--rw-r--r--   0 cyber.anonym   (501) staff       (20)      453 2023-06-02 07:30:49.000000 jax-tools-1.0.29/jax_tools.egg-info/SOURCES.txt
--rw-r--r--   0 cyber.anonym   (501) staff       (20)        1 2023-06-02 07:30:48.000000 jax-tools-1.0.29/jax_tools.egg-info/dependency_links.txt
--rw-r--r--   0 cyber.anonym   (501) staff       (20)       92 2023-06-02 07:30:48.000000 jax-tools-1.0.29/jax_tools.egg-info/entry_points.txt
--rw-r--r--   0 cyber.anonym   (501) staff       (20)       66 2023-06-02 07:30:48.000000 jax-tools-1.0.29/jax_tools.egg-info/requires.txt
--rw-r--r--   0 cyber.anonym   (501) staff       (20)       10 2023-06-02 07:30:48.000000 jax-tools-1.0.29/jax_tools.egg-info/top_level.txt
--rw-r--r--   0 cyber.anonym   (501) staff       (20)       38 2023-06-02 07:30:49.143132 jax-tools-1.0.29/setup.cfg
--rw-r--r--   0 cyber.anonym   (501) staff       (20)     1712 2023-06-02 07:30:48.000000 jax-tools-1.0.29/setup.py
...
### Comparing `jax-tools-1.0.29/jax_tools/logger.py` & `jax-tools-1.0.9/jax_tools/logger.py`

 * *Files identical despite different names*

### Comparing `jax-tools-1.0.29/jax_tools/network_test.py` & `jax-tools-1.0.9/jax_tools/network_test.py`
...
### Comparing `jax-tools-1.0.29/jax_tools/ssh.py` & `jax-tools-1.0.9/jax_tools/ssh_ops.py`
...
### Comparing `jax-tools-1.0.29/setup.py` & `jax-tools-1.0.9/setup.py`
