# Comparing `tmp/pref_voting-0.4.5.tar.gz` & `tmp/pref_voting-0.4.6.tar.gz`
...
### Comparing `pref_voting-0.4.5/pref_voting/other_methods.py` & `pref_voting-0.4.6/pref_voting/other_methods.py`
