# Comparing `tmp/mediacatch-s2t-0.0.6.tar.gz` & `tmp/mediacatch-s2t-0.2.0.tar.gz`
...
### Comparing `mediacatch-s2t-0.0.6/pyproject.toml` & `mediacatch-s2t-0.2.0/pyproject.toml`
