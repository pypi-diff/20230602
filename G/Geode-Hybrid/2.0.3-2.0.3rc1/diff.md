# Comparing `tmp/Geode_Hybrid-2.0.3-cp39-cp39-manylinux2014_x86_64.whl.zip` & `tmp/Geode_Hybrid-2.0.3rc1-cp39-cp39-win_amd64.whl.zip`

## zipinfo {}

```diff
@@ -1,10 +1,10 @@
-Zip file size: 145438 bytes, number of entries: 8
--rw-r--r--  2.0 unx       66 b- defN 23-Jun-02 10:24 geode_hybrid/__init__.py
--rw-r--r--  2.0 unx      225 b- defN 23-Jun-02 10:24 geode_hybrid/brep.py
--rwxr-xr-x  2.0 unx   138784 b- defN 23-Jun-02 10:24 geode_hybrid/lib64/geode_hybrid_py_brep.cpython-39-x86_64-linux-gnu.so
--rwxr-xr-x  2.0 unx   213696 b- defN 23-Jun-02 10:24 geode_hybrid/lib64/libGeode-Hybrid_brep.so
--rw-r--r--  2.0 unx     2171 b- defN 23-Jun-02 10:24 Geode_Hybrid-2.0.3.dist-info/METADATA
--rw-r--r--  2.0 unx      103 b- defN 23-Jun-02 10:24 Geode_Hybrid-2.0.3.dist-info/WHEEL
--rw-r--r--  2.0 unx       13 b- defN 23-Jun-02 10:24 Geode_Hybrid-2.0.3.dist-info/top_level.txt
--rw-rw-r--  2.0 unx      704 b- defN 23-Jun-02 10:24 Geode_Hybrid-2.0.3.dist-info/RECORD
-8 files, 355762 bytes uncompressed, 144200 bytes compressed:  59.5%
...
-Filename: Geode_Hybrid-2.0.3.dist-info/METADATA
+Filename: Geode_Hybrid-2.0.3rc1.dist-info/METADATA
 Comment: 
 
-Filename: Geode_Hybrid-2.0.3.dist-info/WHEEL
+Filename: Geode_Hybrid-2.0.3rc1.dist-info/WHEEL
 Comment: 
 
-Filename: Geode_Hybrid-2.0.3.dist-info/top_level.txt
+Filename: Geode_Hybrid-2.0.3rc1.dist-info/top_level.txt
 Comment: 
 
-Filename: Geode_Hybrid-2.0.3.dist-info/RECORD
...
## Comparing `Geode_Hybrid-2.0.3.dist-info/METADATA` & `Geode_Hybrid-2.0.3rc1.dist-info/METADATA`
...
-Requires-Dist: geode-background (==7.*,>=7.2.0)
-Requires-Dist: geode-common (==26.*,>=26.0.0)
-Requires-Dist: geode-numerics (==3.*,>=3.0.4)
-Requires-Dist: geode-simplex (==6.*,>=6.0.11)
...
```diff
@@ -1,13 +1,14 @@
-Metadata-Version: 2.1 Name: Geode-Hybrid Version: 2.0.3 Summary: Hybrid
...
-Requires-Dist: geode-background (==7.*,>=7.2.0) Requires-Dist: geode-common
-(==26.*,>=26.0.0) Requires-Dist: geode-numerics (==3.*,>=3.0.4) Requires-Dist:
-geode-simplex (==6.*,>=6.0.11) Requires-Dist: opengeode-core (==14.*,>=14.1.10)
