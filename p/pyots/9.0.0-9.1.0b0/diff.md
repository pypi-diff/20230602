# Comparing `tmp/pyots-9.0.0.tar.gz` & `tmp/pyots-9.1.0b0.tar.gz`
...
+gzip compressed data, was "pyots-9.1.0b0.tar", last modified: Fri Jun  2 02:21:12 2023, max compression
```

## Comparing `pyots-9.0.0.tar` & `pyots-9.1.0b0.tar`
...
+drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-06-02 02:21:12.646344 pyots-9.1.0b0/
+-rw-r--r--   0 runner    (1001) docker     (123)       69 2023-06-02 02:17:42.000000 pyots-9.1.0b0/.flake8
+drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-06-02 02:21:12.642344 pyots-9.1.0b0/.github/
+drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-06-02 02:21:12.646344 pyots-9.1.0b0/.github/ISSUE_TEMPLATE/
+-rw-r--r--   0 runner    (1001) docker     (123)      538 2023-06-02 02:17:42.000000 pyots-9.1.0b0/.github/ISSUE_TEMPLATE/bug_report.md
+-rw-r--r--   0 runner    (1001) docker     (123)      610 2023-06-02 02:17:42.000000 pyots-9.1.0b0/.github/ISSUE_TEMPLATE/feature_request.md
+drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-06-02 02:21:12.646344 pyots-9.1.0b0/.github/workflows/
+-rw-r--r--   0 runner    (1001) docker     (123)      834 2023-06-02 02:17:42.000000 pyots-9.1.0b0/.github/workflows/codeql.yml
+-rw-r--r--   0 runner    (1001) docker     (123)     2684 2023-06-02 02:17:42.000000 pyots-9.1.0b0/.github/workflows/release.yml
+-rw-r--r--   0 runner    (1001) docker     (123)     1084 2023-06-02 02:17:42.000000 pyots-9.1.0b0/.github/workflows/run_tests.yml
+-rw-r--r--   0 runner    (1001) docker     (123)     1241 2023-06-02 02:17:42.000000 pyots-9.1.0b0/.gitignore
+-rw-r--r--   0 runner    (1001) docker     (123)     1526 2023-06-02 02:17:42.000000 pyots-9.1.0b0/LICENSE
+-rw-r--r--   0 runner    (1001) docker     (123)     5687 2023-06-02 02:21:12.646344 pyots-9.1.0b0/PKG-INFO
+-rw-r--r--   0 runner    (1001) docker     (123)     4866 2023-06-02 02:17:42.000000 pyots-9.1.0b0/README.md
+-rwxr-xr-x   0 runner    (1001) docker     (123)     2403 2023-06-02 02:17:42.000000 pyots-9.1.0b0/build.py
+-rw-r--r--   0 runner    (1001) docker     (123)      157 2023-06-02 02:17:42.000000 pyots-9.1.0b0/pyproject.toml
+-rw-r--r--   0 runner    (1001) docker     (123)       40 2023-06-02 02:17:42.000000 pyots-9.1.0b0/requirements.txt
+-rw-r--r--   0 runner    (1001) docker     (123)      140 2023-06-02 02:21:12.646344 pyots-9.1.0b0/setup.cfg
+-rw-r--r--   0 runner    (1001) docker     (123)    10099 2023-06-02 02:17:42.000000 pyots-9.1.0b0/setup.py
+drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-06-02 02:21:12.642344 pyots-9.1.0b0/src/
+drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-06-02 02:21:12.646344 pyots-9.1.0b0/src/_pyots/
+-rw-r--r--   0 runner    (1001) docker     (123)     4151 2023-06-02 02:17:42.000000 pyots-9.1.0b0/src/_pyots/bindings.cpp
+-rw-r--r--   0 runner    (1001) docker     (123)     1902 2023-06-02 02:17:42.000000 pyots-9.1.0b0/src/_pyots/pyots-context.h
+drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-06-02 02:21:12.646344 pyots-9.1.0b0/src/pyots/
+-rw-r--r--   0 runner    (1001) docker     (123)     1669 2023-06-02 02:17:42.000000 pyots-9.1.0b0/src/pyots/__init__.py
+drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-06-02 02:21:12.646344 pyots-9.1.0b0/src/pyots.egg-info/
+-rw-r--r--   0 runner    (1001) docker     (123)     5687 2023-06-02 02:21:12.000000 pyots-9.1.0b0/src/pyots.egg-info/PKG-INFO
+-rw-r--r--   0 runner    (1001) docker     (123)      614 2023-06-02 02:21:12.000000 pyots-9.1.0b0/src/pyots.egg-info/SOURCES.txt
+-rw-r--r--   0 runner    (1001) docker     (123)        1 2023-06-02 02:21:12.000000 pyots-9.1.0b0/src/pyots.egg-info/dependency_links.txt
+-rw-r--r--   0 runner    (1001) docker     (123)        1 2023-06-02 02:21:12.000000 pyots-9.1.0b0/src/pyots.egg-info/not-zip-safe
+-rw-r--r--   0 runner    (1001) docker     (123)       13 2023-06-02 02:21:12.000000 pyots-9.1.0b0/src/pyots.egg-info/top_level.txt
+drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-06-02 02:21:12.646344 pyots-9.1.0b0/tests/
+-rw-r--r--   0 runner    (1001) docker     (123)     2987 2023-06-02 02:17:42.000000 pyots-9.1.0b0/tests/test_compare_ots_python.py
+-rw-r--r--   0 runner    (1001) docker     (123)     4850 2023-06-02 02:17:42.000000 pyots-9.1.0b0/tests/test_ots_suite.py
```

### Comparing `pyots-9.0.0/.github/ISSUE_TEMPLATE/bug_report.md` & `pyots-9.1.0b0/.github/ISSUE_TEMPLATE/bug_report.md`

 * *Files identical despite different names*

### Comparing `pyots-9.0.0/.github/ISSUE_TEMPLATE/feature_request.md` & `pyots-9.1.0b0/.github/ISSUE_TEMPLATE/feature_request.md`

 * *Files identical despite different names*

### Comparing `pyots-9.0.0/.github/workflows/release.yml` & `pyots-9.1.0b0/.github/workflows/release.yml`
...
### Comparing `pyots-9.0.0/.github/workflows/run_tests.yml` & `pyots-9.1.0b0/.github/workflows/run_tests.yml`
...
### Comparing `pyots-9.0.0/.gitignore` & `pyots-9.1.0b0/.gitignore`

 * *Files identical despite different names*

### Comparing `pyots-9.0.0/LICENSE` & `pyots-9.1.0b0/LICENSE`

 * *Files identical despite different names*

### Comparing `pyots-9.0.0/PKG-INFO` & `pyots-9.1.0b0/PKG-INFO`
...
### Comparing `pyots-9.0.0/README.md` & `pyots-9.1.0b0/README.md`
...
### Comparing `pyots-9.0.0/build.py` & `pyots-9.1.0b0/build.py`

 * *Files identical despite different names*

### Comparing `pyots-9.0.0/setup.py` & `pyots-9.1.0b0/setup.py`
...
### Comparing `pyots-9.0.0/src/_pyots/bindings.cpp` & `pyots-9.1.0b0/src/_pyots/bindings.cpp`
...
### Comparing `pyots-9.0.0/src/_pyots/pyots-context.h` & `pyots-9.1.0b0/src/_pyots/pyots-context.h`

 * *Files identical despite different names*

### Comparing `pyots-9.0.0/src/pyots/__init__.py` & `pyots-9.1.0b0/src/pyots/__init__.py`
...
### Comparing `pyots-9.0.0/src/pyots.egg-info/PKG-INFO` & `pyots-9.1.0b0/src/pyots.egg-info/PKG-INFO`
...
### Comparing `pyots-9.0.0/src/pyots.egg-info/SOURCES.txt` & `pyots-9.1.0b0/src/pyots.egg-info/SOURCES.txt`
...
### Comparing `pyots-9.0.0/tests/test_compare_ots_python.py` & `pyots-9.1.0b0/tests/test_compare_ots_python.py`

 * *Files identical despite different names*

### Comparing `pyots-9.0.0/tests/test_ots_suite.py` & `pyots-9.1.0b0/tests/test_ots_suite.py`
