# Comparing `tmp/jax-tools-1.0.30.tar.gz` & `tmp/jax-tools-1.0.9.tar.gz`
...
## Comparing `jax-tools-1.0.30.tar` & `jax-tools-1.0.9.tar`
...
### Comparing `jax-tools-1.0.30/jax_tools/logger.py` & `jax-tools-1.0.9/jax_tools/logger.py`

 * *Files identical despite different names*

### Comparing `jax-tools-1.0.30/jax_tools/network_test.py` & `jax-tools-1.0.9/jax_tools/network_test.py`
...
### Comparing `jax-tools-1.0.30/jax_tools/ssh.py` & `jax-tools-1.0.9/jax_tools/ssh_ops.py`
...
### Comparing `jax-tools-1.0.30/setup.py` & `jax-tools-1.0.9/setup.py`
