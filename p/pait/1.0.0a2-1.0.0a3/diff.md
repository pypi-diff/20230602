# Comparing `tmp/pait-1.0.0a2.tar.gz` & `tmp/pait-1.0.0a3.tar.gz`
...
### Comparing `pait-1.0.0a2/README.md` & `pait-1.0.0a3/README.md`
...
### Comparing `pait-1.0.0a2/PKG-INFO` & `pait-1.0.0a3/PKG-INFO`
