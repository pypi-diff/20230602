# Comparing `tmp/lit-16.0.5.tar.gz` & `tmp/lit-16.0.5.post0.tar.gz`
...
## Comparing `lit-16.0.5.tar` & `lit-16.0.5.post0.tar`
...
### Comparing `lit-16.0.5/examples/many-tests/ManyTests.py` & `lit-16.0.5.post0/examples/many-tests/ManyTests.py`

 * *Files identical despite different names*

### Comparing `lit-16.0.5/lit/builtin_commands/cat.py` & `lit-16.0.5.post0/lit/builtin_commands/cat.py`

 * *Files identical despite different names*

### Comparing `lit-16.0.5/lit/builtin_commands/diff.py` & `lit-16.0.5.post0/lit/builtin_commands/diff.py`

 * *Files identical despite different names*

### Comparing `lit-16.0.5/lit/formats/base.py` & `lit-16.0.5.post0/lit/formats/base.py`

 * *Files identical despite different names*

### Comparing `lit-16.0.5/lit/formats/googletest.py` & `lit-16.0.5.post0/lit/formats/googletest.py`

 * *Files identical despite different names*

### Comparing `lit-16.0.5/lit/formats/shtest.py` & `lit-16.0.5.post0/lit/formats/shtest.py`

 * *Files identical despite different names*

### Comparing `lit-16.0.5/lit/llvm/config.py` & `lit-16.0.5.post0/lit/llvm/config.py`

 * *Files identical despite different names*

### Comparing `lit-16.0.5/lit/llvm/subst.py` & `lit-16.0.5.post0/lit/llvm/subst.py`

 * *Files identical despite different names*

### Comparing `lit-16.0.5/lit/BooleanExpression.py` & `lit-16.0.5.post0/lit/BooleanExpression.py`

 * *Files identical despite different names*

### Comparing `lit-16.0.5/lit/LitConfig.py` & `lit-16.0.5.post0/lit/LitConfig.py`

 * *Files identical despite different names*

### Comparing `lit-16.0.5/lit/LitTestCase.py` & `lit-16.0.5.post0/lit/LitTestCase.py`

 * *Files identical despite different names*

### Comparing `lit-16.0.5/lit/ProgressBar.py` & `lit-16.0.5.post0/lit/ProgressBar.py`

 * *Files identical despite different names*

### Comparing `lit-16.0.5/lit/ShCommands.py` & `lit-16.0.5.post0/lit/ShCommands.py`

 * *Files identical despite different names*

### Comparing `lit-16.0.5/lit/ShUtil.py` & `lit-16.0.5.post0/lit/ShUtil.py`

 * *Files identical despite different names*

### Comparing `lit-16.0.5/lit/Test.py` & `lit-16.0.5.post0/lit/Test.py`

 * *Files identical despite different names*

### Comparing `lit-16.0.5/lit/TestRunner.py` & `lit-16.0.5.post0/lit/TestRunner.py`

 * *Files identical despite different names*

### Comparing `lit-16.0.5/lit/TestTimes.py` & `lit-16.0.5.post0/lit/TestTimes.py`

 * *Files identical despite different names*

### Comparing `lit-16.0.5/lit/TestingConfig.py` & `lit-16.0.5.post0/lit/TestingConfig.py`

 * *Files identical despite different names*

### Comparing `lit-16.0.5/lit/cl_arguments.py` & `lit-16.0.5.post0/lit/cl_arguments.py`

 * *Files identical despite different names*

### Comparing `lit-16.0.5/lit/discovery.py` & `lit-16.0.5.post0/lit/discovery.py`

 * *Files identical despite different names*

### Comparing `lit-16.0.5/lit/display.py` & `lit-16.0.5.post0/lit/display.py`

 * *Files identical despite different names*

### Comparing `lit-16.0.5/lit/main.py` & `lit-16.0.5.post0/lit/main.py`

 * *Files identical despite different names*

### Comparing `lit-16.0.5/lit/reports.py` & `lit-16.0.5.post0/lit/reports.py`

 * *Files identical despite different names*

### Comparing `lit-16.0.5/lit/run.py` & `lit-16.0.5.post0/lit/run.py`

 * *Files identical despite different names*

### Comparing `lit-16.0.5/lit/util.py` & `lit-16.0.5.post0/lit/util.py`

 * *Files identical despite different names*

### Comparing `lit-16.0.5/lit/worker.py` & `lit-16.0.5.post0/lit/worker.py`

 * *Files identical despite different names*

### Comparing `lit-16.0.5/lit.egg-info/PKG-INFO` & `lit-16.0.5.post0/lit.egg-info/PKG-INFO`
...
### Comparing `lit-16.0.5/lit.egg-info/SOURCES.txt` & `lit-16.0.5.post0/lit.egg-info/SOURCES.txt`

 * *Files identical despite different names*

### Comparing `lit-16.0.5/tests/Inputs/allow-retries/succeeds-within-limit.py` & `lit-16.0.5.post0/tests/Inputs/allow-retries/succeeds-within-limit.py`

 * *Files identical despite different names*

### Comparing `lit-16.0.5/tests/Inputs/discovery/lit.cfg` & `lit-16.0.5.post0/tests/Inputs/discovery/lit.cfg`

 * *Files identical despite different names*

### Comparing `lit-16.0.5/tests/Inputs/googletest-cmd-wrapper/DummySubDir/OneTest.exe` & `lit-16.0.5.post0/tests/Inputs/googletest-cmd-wrapper/DummySubDir/OneTest.exe`

 * *Files identical despite different names*

### Comparing `lit-16.0.5/tests/Inputs/googletest-crash/DummySubDir/OneTest.py` & `lit-16.0.5.post0/tests/Inputs/googletest-crash/DummySubDir/OneTest.py`

 * *Files identical despite different names*

### Comparing `lit-16.0.5/tests/Inputs/googletest-detect-duplicate/DummySubDir/OneTest.py` & `lit-16.0.5.post0/tests/Inputs/googletest-detect-duplicate/DummySubDir/OneTest.py`

 * *Files identical despite different names*

### Comparing `lit-16.0.5/tests/Inputs/googletest-format/DummySubDir/OneTest.py` & `lit-16.0.5.post0/tests/Inputs/googletest-format/DummySubDir/OneTest.py`

 * *Files identical despite different names*

### Comparing `lit-16.0.5/tests/Inputs/googletest-format-respect-gtest-sharding-env-vars/DummySubDir/OneTest.py` & `lit-16.0.5.post0/tests/Inputs/googletest-format-respect-gtest-sharding-env-vars/DummySubDir/OneTest.py`

 * *Files identical despite different names*

### Comparing `lit-16.0.5/tests/Inputs/googletest-sanitizer-error/DummySubDir/OneTest.py` & `lit-16.0.5.post0/tests/Inputs/googletest-sanitizer-error/DummySubDir/OneTest.py`

 * *Files identical despite different names*

### Comparing `lit-16.0.5/tests/Inputs/googletest-timeout/DummySubDir/OneTest.py` & `lit-16.0.5.post0/tests/Inputs/googletest-timeout/DummySubDir/OneTest.py`

 * *Files identical despite different names*

### Comparing `lit-16.0.5/tests/Inputs/lld-features/lit.cfg` & `lit-16.0.5.post0/tests/Inputs/lld-features/lit.cfg`

 * *Files identical despite different names*

### Comparing `lit-16.0.5/tests/Inputs/shtest-define/errors/defined-check/redefine-multiple-exact.txt` & `lit-16.0.5.post0/tests/Inputs/shtest-define/errors/defined-check/redefine-multiple-exact.txt`

 * *Files identical despite different names*

### Comparing `lit-16.0.5/tests/Inputs/shtest-define/errors/defined-check/redefine-multiple-once-exact.txt` & `lit-16.0.5.post0/tests/Inputs/shtest-define/errors/defined-check/redefine-multiple-once-exact.txt`

 * *Files identical despite different names*

### Comparing `lit-16.0.5/tests/Inputs/shtest-define/examples/param-subst.txt` & `lit-16.0.5.post0/tests/Inputs/shtest-define/examples/param-subst.txt`

 * *Files identical despite different names*

### Comparing `lit-16.0.5/tests/Inputs/shtest-define/expansion-order.txt` & `lit-16.0.5.post0/tests/Inputs/shtest-define/expansion-order.txt`

 * *Files identical despite different names*

### Comparing `lit-16.0.5/tests/Inputs/shtest-define/line-number-substitutions.txt` & `lit-16.0.5.post0/tests/Inputs/shtest-define/line-number-substitutions.txt`

 * *Files identical despite different names*

### Comparing `lit-16.0.5/tests/Inputs/shtest-define/lit.cfg` & `lit-16.0.5.post0/tests/Inputs/shtest-define/lit.cfg`

 * *Files identical despite different names*

### Comparing `lit-16.0.5/tests/Inputs/shtest-define/name-chars.txt` & `lit-16.0.5.post0/tests/Inputs/shtest-define/name-chars.txt`

 * *Files identical despite different names*

### Comparing `lit-16.0.5/tests/Inputs/shtest-define/shared-substs-0.txt` & `lit-16.0.5.post0/tests/Inputs/shtest-define/shared-substs-0.txt`

 * *Files identical despite different names*

### Comparing `lit-16.0.5/tests/Inputs/shtest-define/shared-substs-1.txt` & `lit-16.0.5.post0/tests/Inputs/shtest-define/shared-substs-1.txt`

 * *Files identical despite different names*

### Comparing `lit-16.0.5/tests/Inputs/shtest-define/value-equals.txt` & `lit-16.0.5.post0/tests/Inputs/shtest-define/value-equals.txt`

 * *Files identical despite different names*

### Comparing `lit-16.0.5/tests/Inputs/shtest-define/ws-and-continuations.txt` & `lit-16.0.5.post0/tests/Inputs/shtest-define/ws-and-continuations.txt`

 * *Files identical despite different names*

### Comparing `lit-16.0.5/tests/Inputs/shtest-env/env-calls-env.txt` & `lit-16.0.5.post0/tests/Inputs/shtest-env/env-calls-env.txt`

 * *Files identical despite different names*

### Comparing `lit-16.0.5/tests/Inputs/shtest-env/env-u.txt` & `lit-16.0.5.post0/tests/Inputs/shtest-env/env-u.txt`

 * *Files identical despite different names*

### Comparing `lit-16.0.5/tests/Inputs/shtest-env/mixed.txt` & `lit-16.0.5.post0/tests/Inputs/shtest-env/mixed.txt`

 * *Files identical despite different names*

### Comparing `lit-16.0.5/tests/Inputs/shtest-if-else/test.txt` & `lit-16.0.5.post0/tests/Inputs/shtest-if-else/test.txt`

 * *Files identical despite different names*

### Comparing `lit-16.0.5/tests/Inputs/shtest-not/not-calls-external.txt` & `lit-16.0.5.post0/tests/Inputs/shtest-not/not-calls-external.txt`

 * *Files identical despite different names*

### Comparing `lit-16.0.5/tests/Inputs/shtest-shell/check_path.py` & `lit-16.0.5.post0/tests/Inputs/shtest-shell/check_path.py`

 * *Files identical despite different names*

### Comparing `lit-16.0.5/tests/Inputs/shtest-shell/dev-null.txt` & `lit-16.0.5.post0/tests/Inputs/shtest-shell/dev-null.txt`

 * *Files identical despite different names*

### Comparing `lit-16.0.5/tests/Inputs/shtest-shell/diff-encodings.txt` & `lit-16.0.5.post0/tests/Inputs/shtest-shell/diff-encodings.txt`

 * *Files identical despite different names*

### Comparing `lit-16.0.5/tests/Inputs/shtest-shell/diff-pipes.txt` & `lit-16.0.5.post0/tests/Inputs/shtest-shell/diff-pipes.txt`

 * *Files identical despite different names*

### Comparing `lit-16.0.5/tests/Inputs/shtest-shell/diff-r.txt` & `lit-16.0.5.post0/tests/Inputs/shtest-shell/diff-r.txt`

 * *Files identical despite different names*

### Comparing `lit-16.0.5/tests/Inputs/shtest-shell/diff-unified.txt` & `lit-16.0.5.post0/tests/Inputs/shtest-shell/diff-unified.txt`

 * *Files identical despite different names*

### Comparing `lit-16.0.5/tests/Inputs/shtest-shell/redirects.txt` & `lit-16.0.5.post0/tests/Inputs/shtest-shell/redirects.txt`

 * *Files identical despite different names*

### Comparing `lit-16.0.5/tests/Inputs/shtest-shell/sequencing-0.txt` & `lit-16.0.5.post0/tests/Inputs/shtest-shell/sequencing-0.txt`

 * *Files identical despite different names*

### Comparing `lit-16.0.5/tests/Inputs/shtest-shell/valid-shell.txt` & `lit-16.0.5.post0/tests/Inputs/shtest-shell/valid-shell.txt`

 * *Files identical despite different names*

### Comparing `lit-16.0.5/tests/Inputs/shtest-timeout/lit.cfg` & `lit-16.0.5.post0/tests/Inputs/shtest-timeout/lit.cfg`

 * *Files identical despite different names*

### Comparing `lit-16.0.5/tests/Inputs/test-data/dummy_format.py` & `lit-16.0.5.post0/tests/Inputs/test-data/dummy_format.py`

 * *Files identical despite different names*

### Comparing `lit-16.0.5/tests/Inputs/test-data-micro/dummy_format.py` & `lit-16.0.5.post0/tests/Inputs/test-data-micro/dummy_format.py`

 * *Files identical despite different names*

### Comparing `lit-16.0.5/tests/Inputs/test_retry_attempts/test.py` & `lit-16.0.5.post0/tests/Inputs/test_retry_attempts/test.py`

 * *Files identical despite different names*

### Comparing `lit-16.0.5/tests/Inputs/use-llvm-tool/lit.cfg` & `lit-16.0.5.post0/tests/Inputs/use-llvm-tool/lit.cfg`

 * *Files identical despite different names*

### Comparing `lit-16.0.5/tests/Inputs/xunit-output/dummy_format.py` & `lit-16.0.5.post0/tests/Inputs/xunit-output/dummy_format.py`

 * *Files identical despite different names*

### Comparing `lit-16.0.5/tests/unit/ShUtil.py` & `lit-16.0.5.post0/tests/unit/ShUtil.py`

 * *Files identical despite different names*

### Comparing `lit-16.0.5/tests/unit/TestRunner.py` & `lit-16.0.5.post0/tests/unit/TestRunner.py`

 * *Files identical despite different names*

### Comparing `lit-16.0.5/tests/allow-retries.py` & `lit-16.0.5.post0/tests/allow-retries.py`

 * *Files identical despite different names*

### Comparing `lit-16.0.5/tests/discovery.py` & `lit-16.0.5.post0/tests/discovery.py`

 * *Files identical despite different names*

### Comparing `lit-16.0.5/tests/googletest-crash.py` & `lit-16.0.5.post0/tests/googletest-crash.py`

 * *Files identical despite different names*

### Comparing `lit-16.0.5/tests/googletest-format-respect-gtest-sharding-env-vars.py` & `lit-16.0.5.post0/tests/googletest-format-respect-gtest-sharding-env-vars.py`

 * *Files identical despite different names*

### Comparing `lit-16.0.5/tests/googletest-format.py` & `lit-16.0.5.post0/tests/googletest-format.py`

 * *Files identical despite different names*

### Comparing `lit-16.0.5/tests/googletest-sanitizer-error.py` & `lit-16.0.5.post0/tests/googletest-sanitizer-error.py`

 * *Files identical despite different names*

### Comparing `lit-16.0.5/tests/googletest-timeout.py` & `lit-16.0.5.post0/tests/googletest-timeout.py`

 * *Files identical despite different names*

### Comparing `lit-16.0.5/tests/ignore-fail.py` & `lit-16.0.5.post0/tests/ignore-fail.py`

 * *Files identical despite different names*

### Comparing `lit-16.0.5/tests/lit-opts.py` & `lit-16.0.5.post0/tests/lit-opts.py`

 * *Files identical despite different names*

### Comparing `lit-16.0.5/tests/lit.cfg` & `lit-16.0.5.post0/tests/lit.cfg`

 * *Files identical despite different names*

### Comparing `lit-16.0.5/tests/max-failures.py` & `lit-16.0.5.post0/tests/max-failures.py`

 * *Files identical despite different names*

### Comparing `lit-16.0.5/tests/parallelism-groups.py` & `lit-16.0.5.post0/tests/parallelism-groups.py`

 * *Files identical despite different names*

### Comparing `lit-16.0.5/tests/progress-bar.py` & `lit-16.0.5.post0/tests/progress-bar.py`

 * *Files identical despite different names*

### Comparing `lit-16.0.5/tests/reorder.py` & `lit-16.0.5.post0/tests/reorder.py`

 * *Files identical despite different names*

### Comparing `lit-16.0.5/tests/selecting.py` & `lit-16.0.5.post0/tests/selecting.py`

 * *Files identical despite different names*

### Comparing `lit-16.0.5/tests/show-result-codes.py` & `lit-16.0.5.post0/tests/show-result-codes.py`

 * *Files identical despite different names*

### Comparing `lit-16.0.5/tests/show-used-features.py` & `lit-16.0.5.post0/tests/show-used-features.py`

 * *Files identical despite different names*

### Comparing `lit-16.0.5/tests/shtest-define.py` & `lit-16.0.5.post0/tests/shtest-define.py`

 * *Files identical despite different names*

### Comparing `lit-16.0.5/tests/shtest-env.py` & `lit-16.0.5.post0/tests/shtest-env.py`

 * *Files identical despite different names*

### Comparing `lit-16.0.5/tests/shtest-format-argv0.py` & `lit-16.0.5.post0/tests/shtest-format-argv0.py`

 * *Files identical despite different names*

### Comparing `lit-16.0.5/tests/shtest-format.py` & `lit-16.0.5.post0/tests/shtest-format.py`

 * *Files identical despite different names*

### Comparing `lit-16.0.5/tests/shtest-if-else.py` & `lit-16.0.5.post0/tests/shtest-if-else.py`

 * *Files identical despite different names*

### Comparing `lit-16.0.5/tests/shtest-inject.py` & `lit-16.0.5.post0/tests/shtest-inject.py`

 * *Files identical despite different names*

### Comparing `lit-16.0.5/tests/shtest-keyword-parse-errors.py` & `lit-16.0.5.post0/tests/shtest-keyword-parse-errors.py`

 * *Files identical despite different names*

### Comparing `lit-16.0.5/tests/shtest-not.py` & `lit-16.0.5.post0/tests/shtest-not.py`

 * *Files identical despite different names*

### Comparing `lit-16.0.5/tests/shtest-output-printing.py` & `lit-16.0.5.post0/tests/shtest-output-printing.py`

 * *Files identical despite different names*

### Comparing `lit-16.0.5/tests/shtest-pushd-popd.py` & `lit-16.0.5.post0/tests/shtest-pushd-popd.py`

 * *Files identical despite different names*

### Comparing `lit-16.0.5/tests/shtest-recursive-substitution.py` & `lit-16.0.5.post0/tests/shtest-recursive-substitution.py`

 * *Files identical despite different names*

### Comparing `lit-16.0.5/tests/shtest-run-at-line.py` & `lit-16.0.5.post0/tests/shtest-run-at-line.py`

 * *Files identical despite different names*

### Comparing `lit-16.0.5/tests/shtest-shell.py` & `lit-16.0.5.post0/tests/shtest-shell.py`

 * *Files identical despite different names*

### Comparing `lit-16.0.5/tests/shtest-timeout.py` & `lit-16.0.5.post0/tests/shtest-timeout.py`

 * *Files identical despite different names*

### Comparing `lit-16.0.5/tests/test-data-micro.py` & `lit-16.0.5.post0/tests/test-data-micro.py`

 * *Files identical despite different names*

### Comparing `lit-16.0.5/tests/test-output-micro-resultdb.py` & `lit-16.0.5.post0/tests/test-output-micro-resultdb.py`

 * *Files identical despite different names*

### Comparing `lit-16.0.5/tests/test-output-micro.py` & `lit-16.0.5.post0/tests/test-output-micro.py`

 * *Files identical despite different names*

### Comparing `lit-16.0.5/tests/test-output-resultdb.py` & `lit-16.0.5.post0/tests/test-output-resultdb.py`

 * *Files identical despite different names*

### Comparing `lit-16.0.5/tests/test-output.py` & `lit-16.0.5.post0/tests/test-output.py`

 * *Files identical despite different names*

### Comparing `lit-16.0.5/tests/unparsed-requirements.py` & `lit-16.0.5.post0/tests/unparsed-requirements.py`

 * *Files identical despite different names*

### Comparing `lit-16.0.5/tests/use-llvm-tool.py` & `lit-16.0.5.post0/tests/use-llvm-tool.py`

 * *Files identical despite different names*

### Comparing `lit-16.0.5/tests/xfail-cl.py` & `lit-16.0.5.post0/tests/xfail-cl.py`

 * *Files identical despite different names*

### Comparing `lit-16.0.5/tests/xunit-output.py` & `lit-16.0.5.post0/tests/xunit-output.py`

 * *Files identical despite different names*

### Comparing `lit-16.0.5/README.rst` & `lit-16.0.5.post0/README.rst`

 * *Files identical despite different names*

### Comparing `lit-16.0.5/setup.py` & `lit-16.0.5.post0/setup.py`

 * *Files identical despite different names*

### Comparing `lit-16.0.5/PKG-INFO` & `lit-16.0.5.post0/PKG-INFO`
