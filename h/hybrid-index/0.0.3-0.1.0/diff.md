# Comparing `tmp/hybrid_index-0.0.3.tar.gz` & `tmp/hybrid_index-0.1.0.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "hybrid_index-0.0.3.tar", last modified: Fri Jun  2 10:17:34 2023, max compression
+gzip compressed data, was "hybrid_index-0.1.0.tar", last modified: Fri Jun  2 09:44:51 2023, max compression
```

## Comparing `hybrid_index-0.0.3.tar` & `hybrid_index-0.1.0.tar`

### file list

```diff
@@ -1,14 +1,15 @@
-drwxrwxr-x   0 gigagiova  (1000) gigagiova  (1000)        0 2023-06-02 10:17:34.908066 hybrid_index-0.0.3/
--rw-rw-r--   0 gigagiova  (1000) gigagiova  (1000)      480 2023-06-02 10:17:34.908066 hybrid_index-0.0.3/PKG-INFO
-drwxrwxr-x   0 gigagiova  (1000) gigagiova  (1000)        0 2023-06-02 10:17:34.904066 hybrid_index-0.0.3/hybrid/
-drwxrwxr-x   0 gigagiova  (1000) gigagiova  (1000)        0 2023-06-02 10:17:34.908066 hybrid_index-0.0.3/hybrid/hybrid_index/
--rw-rw-r--   0 gigagiova  (1000) gigagiova  (1000)       83 2023-06-02 09:42:53.000000 hybrid_index-0.0.3/hybrid/hybrid_index/__init__.py
--rw-rw-r--   0 gigagiova  (1000) gigagiova  (1000)     7078 2023-06-02 08:36:03.000000 hybrid_index-0.0.3/hybrid/hybrid_index/index.py
-drwxrwxr-x   0 gigagiova  (1000) gigagiova  (1000)        0 2023-06-02 10:17:34.908066 hybrid_index-0.0.3/hybrid/hybrid_index.egg-info/
--rw-rw-r--   0 gigagiova  (1000) gigagiova  (1000)      480 2023-06-02 10:17:34.000000 hybrid_index-0.0.3/hybrid/hybrid_index.egg-info/PKG-INFO
--rw-rw-r--   0 gigagiova  (1000) gigagiova  (1000)      283 2023-06-02 10:17:34.000000 hybrid_index-0.0.3/hybrid/hybrid_index.egg-info/SOURCES.txt
--rw-rw-r--   0 gigagiova  (1000) gigagiova  (1000)        1 2023-06-02 10:17:34.000000 hybrid_index-0.0.3/hybrid/hybrid_index.egg-info/dependency_links.txt
--rw-rw-r--   0 gigagiova  (1000) gigagiova  (1000)      268 2023-06-02 10:17:34.000000 hybrid_index-0.0.3/hybrid/hybrid_index.egg-info/requires.txt
--rw-rw-r--   0 gigagiova  (1000) gigagiova  (1000)       13 2023-06-02 10:17:34.000000 hybrid_index-0.0.3/hybrid/hybrid_index.egg-info/top_level.txt
--rw-rw-r--   0 gigagiova  (1000) gigagiova  (1000)       38 2023-06-02 10:17:34.908066 hybrid_index-0.0.3/setup.cfg
--rw-rw-r--   0 gigagiova  (1000) gigagiova  (1000)     1268 2023-06-02 10:17:32.000000 hybrid_index-0.0.3/setup.py
...
### Comparing `hybrid_index-0.0.3/hybrid/hybrid_index/index.py` & `hybrid_index-0.1.0/hybrid/hybrid_index/index.py`

 * *Files identical despite different names*

### Comparing `hybrid_index-0.0.3/setup.py` & `hybrid_index-0.1.0/setup.py`
