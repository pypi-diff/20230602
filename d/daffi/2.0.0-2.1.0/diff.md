# Comparing `tmp/daffi-2.0.0.tar.gz` & `tmp/daffi-2.1.0.tar.gz`
...
### Comparing `daffi-2.0.0/daffi/interface.py` & `daffi-2.1.0/daffi/interface.py`
...
### Comparing `daffi-2.0.0/daffi/method_executors.py` & `daffi-2.1.0/daffi/method_executors.py`
...
### Comparing `daffi-2.0.0/daffi/remote_call.py` & `daffi-2.1.0/daffi/remote_call.py`
...
### Comparing `daffi-2.0.0/daffi/components/__init__.py` & `daffi-2.1.0/daffi/components/__init__.py`
...
### Comparing `daffi-2.0.0/daffi/components/controller.py` & `daffi-2.1.0/daffi/components/controller.py`
...
### Comparing `daffi-2.0.0/daffi/components/node.py` & `daffi-2.1.0/daffi/components/node.py`
...
### Comparing `daffi-2.0.0/daffi/components/scheduler.py` & `daffi-2.1.0/daffi/components/scheduler.py`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/daffi/components/operations/channel_store.py` & `daffi-2.1.0/daffi/components/operations/channel_store.py`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/daffi/components/operations/controller_operations.py` & `daffi-2.1.0/daffi/components/operations/controller_operations.py`
...
### Comparing `daffi-2.0.0/daffi/components/operations/freezable_queue.py` & `daffi-2.1.0/daffi/components/operations/freezable_queue.py`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/daffi/components/operations/node_operations.py` & `daffi-2.1.0/daffi/components/operations/node_operations.py`
...
### Comparing `daffi-2.0.0/daffi/components/operations/streams_store.py` & `daffi-2.1.0/daffi/components/operations/streams_store.py`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/daffi/components/operations/task_waiter.py` & `daffi-2.1.0/daffi/components/operations/task_waiter.py`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/daffi/components/operations/ttl_store.py` & `daffi-2.1.0/daffi/components/operations/ttl_store.py`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/daffi/components/proto/message.py` & `daffi-2.1.0/daffi/components/proto/message.py`
...
### Comparing `daffi-2.0.0/daffi/components/proto/messager.proto` & `daffi-2.1.0/daffi/components/proto/messager.proto`
...
### Comparing `daffi-2.0.0/daffi/components/proto/messager_pb2.py` & `daffi-2.1.0/daffi/components/proto/messager_pb2.py`
...
### Comparing `daffi-2.0.0/daffi/components/proto/messager_pb2_grpc.py` & `daffi-2.1.0/daffi/components/proto/messager_pb2_grpc.py`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/daffi/decorators/_base.py` & `daffi-2.1.0/daffi/decorators/_base.py`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/daffi/decorators/_callback.py` & `daffi-2.1.0/daffi/decorators/_callback.py`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/daffi/decorators/_fetcher.py` & `daffi-2.1.0/daffi/decorators/_fetcher.py`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/daffi/registry/_base.py` & `daffi-2.1.0/daffi/registry/_base.py`
...
### Comparing `daffi-2.0.0/daffi/registry/_callback.py` & `daffi-2.1.0/daffi/registry/_callback.py`
...
### Comparing `daffi-2.0.0/daffi/registry/_fetcher.py` & `daffi-2.1.0/daffi/registry/_fetcher.py`
...
### Comparing `daffi-2.0.0/daffi/utils/colors.py` & `daffi-2.1.0/daffi/utils/colors.py`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/daffi/utils/debug.py` & `daffi-2.1.0/daffi/utils/debug.py`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/daffi/utils/func_validation.py` & `daffi-2.1.0/daffi/utils/func_validation.py`
...
### Comparing `daffi-2.0.0/daffi/utils/logger.py` & `daffi-2.1.0/daffi/utils/logger.py`
...
### Comparing `daffi-2.0.0/daffi/utils/misc.py` & `daffi-2.1.0/daffi/utils/misc.py`
...
### Comparing `daffi-2.0.0/daffi/utils/timeparse.py` & `daffi-2.1.0/daffi/utils/timeparse.py`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/docs/async-apps.md` & `daffi-2.1.0/docs/async-apps.md`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/docs/execution-modifiers.md` & `daffi-2.1.0/docs/execution-modifiers.md`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/docs/global-object.md` & `daffi-2.1.0/docs/global-object.md`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/docs/index.md` & `daffi-2.1.0/docs/index.md`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/docs/node-and-controller.md` & `daffi-2.1.0/docs/node-and-controller.md`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/docs/images/bg.jpg` & `daffi-2.1.0/docs/images/bg.jpg`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/docs/images/controller-plus-node-arch.drawio` & `daffi-2.1.0/docs/images/controller-plus-node-arch.drawio`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/docs/images/controller-plus-node-arch.png` & `daffi-2.1.0/docs/images/controller-plus-node-arch.png`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/docs/images/gitter.png` & `daffi-2.1.0/docs/images/gitter.png`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/docs/images/logo-white-sm.png` & `daffi-2.1.0/docs/images/logo-white-sm.png`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/docs/images/logo-white.png` & `daffi-2.1.0/docs/images/logo-white.png`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/docs/images/logo.png` & `daffi-2.1.0/docs/images/logo.png`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/docs/images/many-controllers.drawio` & `daffi-2.1.0/docs/images/many-controllers.drawio`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/docs/images/many-controllers.png` & `daffi-2.1.0/docs/images/many-controllers.png`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/docs/images/pdf-file.png` & `daffi-2.1.0/docs/images/pdf-file.png`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/docs/images/stand-alone-controller-arch.drawio` & `daffi-2.1.0/docs/images/stand-alone-controller-arch.drawio`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/docs/images/stand-alone-controller-arch.png` & `daffi-2.1.0/docs/images/stand-alone-controller-arch.png`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/docs/js/extra.js` & `daffi-2.1.0/docs/js/extra.js`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/docs/stylesheets/extra.css` & `daffi-2.1.0/docs/stylesheets/extra.css`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/docs/usage/aliased-methods.md` & `daffi-2.1.0/docs/usage/aliased-methods.md`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/docs/usage/asynchronous-execution.md` & `daffi-2.1.0/docs/usage/asynchronous-execution.md`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/docs/usage/basic-example.md` & `daffi-2.1.0/docs/usage/basic-example.md`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/docs/usage/bidirectional-communication.md` & `daffi-2.1.0/docs/usage/bidirectional-communication.md`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/docs/usage/broadcasting.md` & `daffi-2.1.0/docs/usage/broadcasting.md`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/docs/usage/callback-additional-arguments.md` & `daffi-2.1.0/docs/usage/callback-additional-arguments.md`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/docs/usage/fetchers-with-body.md` & `daffi-2.1.0/docs/usage/fetchers-with-body.md`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/docs/usage/function-transfer.md` & `daffi-2.1.0/docs/usage/function-transfer.md`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/docs/usage/named-processes.md` & `daffi-2.1.0/docs/usage/named-processes.md`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/docs/usage/private-methods.md` & `daffi-2.1.0/docs/usage/private-methods.md`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/docs/usage/stream-callback-to-fetcher.md` & `daffi-2.1.0/docs/usage/stream-callback-to-fetcher.md`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/docs/usage/stream-fetcher-to-callback.md` & `daffi-2.1.0/docs/usage/stream-fetcher-to-callback.md`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/examples/docker/colorizer/main.py` & `daffi-2.1.0/examples/docker/colorizer/main.py`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/examples/docker/email_processor/main.py` & `daffi-2.1.0/examples/docker/email_processor/main.py`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/examples/docker/web/app.py` & `daffi-2.1.0/examples/docker/web/app.py`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/examples/docker/web/templates/base.html` & `daffi-2.1.0/examples/docker/web/templates/base.html`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/examples/docker/web/templates/index.html` & `daffi-2.1.0/examples/docker/web/templates/index.html`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/examples/opencv_stream/classes_based/consumer.py` & `daffi-2.1.0/examples/opencv_stream/classes_based/consumer.py`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/examples/opencv_stream/classes_based/publisher1.py` & `daffi-2.1.0/examples/opencv_stream/classes_based/publisher1.py`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/examples/opencv_stream/classes_based/publisher2.py` & `daffi-2.1.0/examples/opencv_stream/classes_based/publisher2.py`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/examples/opencv_stream/classes_based/publisher3.py` & `daffi-2.1.0/examples/opencv_stream/classes_based/publisher3.py`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/examples/opencv_stream/decorators_based/consumer.py` & `daffi-2.1.0/examples/opencv_stream/decorators_based/consumer.py`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/examples/opencv_stream/decorators_based/publisher1.py` & `daffi-2.1.0/examples/opencv_stream/decorators_based/publisher1.py`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/examples/opencv_stream/decorators_based/publisher2.py` & `daffi-2.1.0/examples/opencv_stream/decorators_based/publisher2.py`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/examples/opencv_stream/decorators_based/publisher3.py` & `daffi-2.1.0/examples/opencv_stream/decorators_based/publisher3.py`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/examples/tcp/callbacks_from_class/consumer.py` & `daffi-2.1.0/examples/tcp/callbacks_from_class/consumer.py`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/examples/tcp/callbacks_from_class/publisher.py` & `daffi-2.1.0/examples/tcp/callbacks_from_class/publisher.py`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/examples/tcp/eta/consumer.py` & `daffi-2.1.0/examples/tcp/eta/consumer.py`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/examples/tcp/eta/publisher.py` & `daffi-2.1.0/examples/tcp/eta/publisher.py`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/examples/tcp/no_return/consumer.py` & `daffi-2.1.0/examples/tcp/no_return/consumer.py`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/examples/tcp/no_return/publisher.py` & `daffi-2.1.0/examples/tcp/no_return/publisher.py`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/examples/tcp/scheduler/consumer.py` & `daffi-2.1.0/examples/tcp/scheduler/consumer.py`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/examples/tcp/scheduler/publisher.py` & `daffi-2.1.0/examples/tcp/scheduler/publisher.py`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/examples/tcp/stream/consumer.py` & `daffi-2.1.0/examples/tcp/stream/consumer.py`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/examples/tcp/stream/publisher.py` & `daffi-2.1.0/examples/tcp/stream/publisher.py`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/examples/tcp/transfer_and_call/consumer.py` & `daffi-2.1.0/examples/tcp/transfer_and_call/consumer.py`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/examples/tcp/two_processes_base_communication/class_based/proc1.py` & `daffi-2.1.0/examples/tcp/two_processes_base_communication/class_based/proc1.py`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/examples/tcp/two_processes_base_communication/class_based/proc2.py` & `daffi-2.1.0/examples/tcp/two_processes_base_communication/class_based/proc2.py`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/examples/tcp/two_processes_base_communication/decorators_based/proc1.py` & `daffi-2.1.0/examples/tcp/two_processes_base_communication/decorators_based/proc1.py`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/examples/tcp/two_processes_base_communication/decorators_based/proc2.py` & `daffi-2.1.0/examples/tcp/two_processes_base_communication/decorators_based/proc2.py`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/examples/tcp/two_processes_base_communication_asyncio/class_based/proc1.py` & `daffi-2.1.0/examples/tcp/two_processes_base_communication_asyncio/class_based/proc1.py`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/examples/tcp/two_processes_base_communication_asyncio/class_based/proc2.py` & `daffi-2.1.0/examples/tcp/two_processes_base_communication_asyncio/class_based/proc2.py`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/examples/tcp/two_processes_base_communication_asyncio/decorators_based/proc1.py` & `daffi-2.1.0/examples/tcp/two_processes_base_communication_asyncio/decorators_based/proc1.py`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/examples/tcp/two_processes_base_communication_asyncio/decorators_based/proc2.py` & `daffi-2.1.0/examples/tcp/two_processes_base_communication_asyncio/decorators_based/proc2.py`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/examples/tcp/two_processes_base_communication_trio/class_based/proc1.py` & `daffi-2.1.0/examples/tcp/two_processes_base_communication_trio/class_based/proc1.py`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/examples/tcp/two_processes_base_communication_trio/class_based/proc2.py` & `daffi-2.1.0/examples/tcp/two_processes_base_communication_trio/class_based/proc2.py`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/examples/tcp/two_processes_base_communication_trio/decorators_based/proc1.py` & `daffi-2.1.0/examples/tcp/two_processes_base_communication_trio/decorators_based/proc1.py`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/examples/tcp/two_processes_base_communication_trio/decorators_based/proc2.py` & `daffi-2.1.0/examples/tcp/two_processes_base_communication_trio/decorators_based/proc2.py`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/examples/unix_socket/callback_and_fetcher_decorator/consumer.py` & `daffi-2.1.0/examples/unix_socket/callback_and_fetcher_decorator/consumer.py`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/examples/unix_socket/callback_and_fetcher_decorator/publisher.py` & `daffi-2.1.0/examples/unix_socket/callback_and_fetcher_decorator/publisher.py`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/examples/unix_socket/callback_and_fetcher_in_one_class/class_consumer.py` & `daffi-2.1.0/examples/unix_socket/callback_and_fetcher_in_one_class/class_consumer.py`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/examples/unix_socket/callback_and_fetcher_in_one_class/class_publisher.py` & `daffi-2.1.0/examples/unix_socket/callback_and_fetcher_in_one_class/class_publisher.py`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/examples/unix_socket/callback_generator/class_consumer.py` & `daffi-2.1.0/examples/unix_socket/callback_generator/class_consumer.py`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/examples/unix_socket/callback_generator/class_publisher.py` & `daffi-2.1.0/examples/unix_socket/callback_generator/class_publisher.py`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/examples/unix_socket/callbacks_from_class/consumer.py` & `daffi-2.1.0/examples/unix_socket/callbacks_from_class/consumer.py`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/examples/unix_socket/callbacks_from_class/publisher.py` & `daffi-2.1.0/examples/unix_socket/callbacks_from_class/publisher.py`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/examples/unix_socket/eta/class_consumer.py` & `daffi-2.1.0/examples/unix_socket/eta/class_consumer.py`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/examples/unix_socket/eta/class_publisher.py` & `daffi-2.1.0/examples/unix_socket/eta/class_publisher.py`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/examples/unix_socket/eta/consumer.py` & `daffi-2.1.0/examples/unix_socket/eta/consumer.py`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/examples/unix_socket/eta/publisher.py` & `daffi-2.1.0/examples/unix_socket/eta/publisher.py`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/examples/unix_socket/fetcher_generator/class_consumer.py` & `daffi-2.1.0/examples/unix_socket/fetcher_generator/class_consumer.py`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/examples/unix_socket/fetcher_generator/class_publisher.py` & `daffi-2.1.0/examples/unix_socket/fetcher_generator/class_publisher.py`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/examples/unix_socket/no_return/consumer.py` & `daffi-2.1.0/examples/unix_socket/no_return/consumer.py`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/examples/unix_socket/no_return/publisher.py` & `daffi-2.1.0/examples/unix_socket/no_return/publisher.py`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/examples/unix_socket/scheduler/consumer.py` & `daffi-2.1.0/examples/unix_socket/scheduler/consumer.py`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/examples/unix_socket/scheduler/publisher.py` & `daffi-2.1.0/examples/unix_socket/scheduler/publisher.py`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/examples/unix_socket/stream/consumer.py` & `daffi-2.1.0/examples/unix_socket/stream/consumer.py`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/examples/unix_socket/stream/publisher.py` & `daffi-2.1.0/examples/unix_socket/stream/publisher.py`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/examples/unix_socket/transfer_and_call/consumer.py` & `daffi-2.1.0/examples/unix_socket/transfer_and_call/consumer.py`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/examples/unix_socket/two_processes_base_communication/class_based/proc1.py` & `daffi-2.1.0/examples/unix_socket/two_processes_base_communication/class_based/proc1.py`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/examples/unix_socket/two_processes_base_communication/class_based/proc2.py` & `daffi-2.1.0/examples/unix_socket/two_processes_base_communication/class_based/proc2.py`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/examples/unix_socket/two_processes_base_communication/decorators_based/proc1.py` & `daffi-2.1.0/examples/unix_socket/two_processes_base_communication/decorators_based/proc1.py`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/examples/unix_socket/two_processes_base_communication/decorators_based/proc2.py` & `daffi-2.1.0/examples/unix_socket/two_processes_base_communication/decorators_based/proc2.py`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/examples/unix_socket/two_processes_base_communication_asyncio/class_based/proc1.py` & `daffi-2.1.0/examples/unix_socket/two_processes_base_communication_asyncio/class_based/proc1.py`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/examples/unix_socket/two_processes_base_communication_asyncio/class_based/proc2.py` & `daffi-2.1.0/examples/unix_socket/two_processes_base_communication_asyncio/class_based/proc2.py`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/examples/unix_socket/two_processes_base_communication_asyncio/decorators_based/proc1.py` & `daffi-2.1.0/examples/unix_socket/two_processes_base_communication_asyncio/decorators_based/proc1.py`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/examples/unix_socket/two_processes_base_communication_asyncio/decorators_based/proc2.py` & `daffi-2.1.0/examples/unix_socket/two_processes_base_communication_asyncio/decorators_based/proc2.py`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/examples/unix_socket/two_processes_base_communication_trio/class_based/proc1.py` & `daffi-2.1.0/examples/unix_socket/two_processes_base_communication_trio/class_based/proc1.py`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/examples/unix_socket/two_processes_base_communication_trio/class_based/proc2.py` & `daffi-2.1.0/examples/unix_socket/two_processes_base_communication_trio/class_based/proc2.py`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/examples/unix_socket/two_processes_base_communication_trio/decorators_based/proc1.py` & `daffi-2.1.0/examples/unix_socket/two_processes_base_communication_trio/decorators_based/proc1.py`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/examples/unix_socket/two_processes_base_communication_trio/decorators_based/proc2.py` & `daffi-2.1.0/examples/unix_socket/two_processes_base_communication_trio/decorators_based/proc2.py`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/scripts/generate_coverage_summary.py` & `daffi-2.1.0/scripts/generate_coverage_summary.py`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/scripts/write_coverage_summary_report.py` & `daffi-2.1.0/scripts/write_coverage_summary_report.py`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/tests/conftest.py` & `daffi-2.1.0/tests/conftest.py`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/tests/integration/conftest.py` & `daffi-2.1.0/tests/integration/conftest.py`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/tests/integration/test_broadcast.py` & `daffi-2.1.0/tests/integration/test_broadcast.py`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/tests/integration/test_many_callbacks.py` & `daffi-2.1.0/tests/integration/test_many_callbacks.py`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/tests/integration/test_many_nodes.py` & `daffi-2.1.0/tests/integration/test_many_nodes.py`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/tests/integration/test_period.py` & `daffi-2.1.0/tests/integration/test_period.py`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/tests/integration/test_pipeline.py` & `daffi-2.1.0/tests/integration/test_pipeline.py`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/tests/integration/test_stream_callback_to_fetcher.py` & `daffi-2.1.0/tests/integration/test_stream_callback_to_fetcher.py`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/tests/integration/test_stream_fetcher_to_callback.py` & `daffi-2.1.0/tests/integration/test_stream_fetcher_to_callback.py`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/tests/integration/test_trio.py` & `daffi-2.1.0/tests/integration/test_trio.py`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/tests/integration/templates/test_trio.jinja2` & `daffi-2.1.0/tests/integration/templates/test_trio.jinja2`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/tests/integration/templates/layout/base.jinja2` & `daffi-2.1.0/tests/integration/templates/layout/base.jinja2`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/tests/unit/test_async_result.py` & `daffi-2.1.0/tests/unit/test_async_result.py`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/tests/unit/test_callback_and_fecher_classes.py` & `daffi-2.1.0/tests/unit/test_callback_and_fecher_classes.py`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/tests/unit/test_callback_decorator.py` & `daffi-2.1.0/tests/unit/test_callback_decorator.py`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/tests/unit/test_fetcher_decorator.py` & `daffi-2.1.0/tests/unit/test_fetcher_decorator.py`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/tests/unit/test_freezable_queue.py` & `daffi-2.1.0/tests/unit/test_freezable_queue.py`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/tests/unit/test_logger.py` & `daffi-2.1.0/tests/unit/test_logger.py`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/tests/unit/test_misc.py` & `daffi-2.1.0/tests/unit/test_misc.py`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/.gitignore` & `daffi-2.1.0/.gitignore`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/LICENSE.txt` & `daffi-2.1.0/LICENSE.txt`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/README.md` & `daffi-2.1.0/README.md`

 * *Files identical despite different names*

### Comparing `daffi-2.0.0/pyproject.toml` & `daffi-2.1.0/pyproject.toml`
...
### Comparing `daffi-2.0.0/PKG-INFO` & `daffi-2.1.0/PKG-INFO`
