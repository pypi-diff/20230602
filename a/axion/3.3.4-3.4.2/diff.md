# Comparing `tmp/axion-3.3.4-cp311-cp311-win_amd64.whl.zip` & `tmp/axion-3.4.2-cp311-cp311-win_amd64.whl.zip`
...
## Comparing `axion-3.3.4.dist-info/LICENSE` & `axion-3.4.2.dist-info/LICENSE`

 * *Files identical despite different names*

## Comparing `axion-3.3.4.dist-info/METADATA` & `axion-3.4.2.dist-info/METADATA`
